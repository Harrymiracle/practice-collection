...
//const CDN = 'http://wxlgd.guxiansheng.cn';
...
gulp.task('devs', function () {
	...
	runSequence('views','sass','js', 'images',function () {
...
function build(cb) {
	runSequence('clean','sass', 'css:build','js:build', 'ugjs:build', 'views:build', 'images',function() {
		// 上传静态资源文件到CDN
		cb && cb();
