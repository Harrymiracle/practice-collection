  ...
  initUI: function pdfViewInitUI() {
    ...
    document
      ...
      .addEventListener("change", function() {
        PDFViewerApplication.page = this.value | 0;   // 向下取整
...
document.addEventListener(
  "DOMContentLoaded",   // 参考https://www.cnblogs.com/caizhenbo/p/6679478.html
  function() {
    PDFViewerApplication.initUI();  // 先执行。
  },
  true
);
...
(function animationStartedClosure() {
  ...
  PDFViewerApplication.animationStartedPromise = new Promise(function(resolve) {
    // 参考https://developer.mozilla.org/zh-CN/docs/Web/API/Window/requestAnimationFrame
...
PDFViewerApplication.animationStartedPromise.then(function() {
  PDFViewerApplication.open({ // 在promise的then中，后执行。 
    url: DEFAULT_URL,
  });
});
