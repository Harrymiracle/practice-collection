...
angular.module('ui.ey-ui').run(['$templateCache', function($templateCache) {$templateCache.put('leftMenuCompoment/tpl/eyuiLeftMenu-sub-tpl.html','<a ng-bind=\'menu.label\' ng-click=\'clickFn(menu)\' ng-class=\'{selected:menu.selected && !menu.sub}\' ng-href=\'{{menu.href}}\'></a>\n<i ng-if=\'menu.sub\' class=\'collapsed\'>&gt;</i>\n<ul ng-if=\'menu.sub\' ng-class=\'{collapsed:menu.collapsed}\'>\n    <li ng-repeat=\'menu in menu.sub\' ng-include=\'"leftMenuCompoment/tpl/eyuiLeftMenu-sub-tpl.html"\'></li>\n</ul>\n');
...
$templateCache.put('accordionCompoment/tpl/accordion.html','<div role="tablist" class="panel-group" ng-transclude></div>');
